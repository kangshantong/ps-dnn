...
int main(int argc, char* argv[])
{
  ...
  if (!isWorker) {
    ...
    for(int i = 0; i < workers; i++) {
      ...
      threadList.push_back(thread(run_worker, dnn_conf_file, fea_conf_file, train_file, test_file, param2key_file, last_param2key_file, i));
    }
    ...
    cout<<"Worker Exiting from Main Thread"<<endl;
  }
  return 0;
}
